    ...
    <>
      <div className="min-h-screen bg-white text-gray-200 px-6 py-12 ">
        ...
        <div className="mt-10 bg-[#1a1525] rounded-2xl shadow-lg p-8 max-w-4xl mx-auto leading-relaxed">
          ...
          <p className="mb-6">
            Like most digital platforms, we collect IP address, browser type,
            ISP, date/time stamps, referring/exit pages, and clicks for
            analytics only.
          </p>
          <p>
            This data is used strictly for analytical and site administration
            purposes. It is not linked to any personally identifiable
            information.
          </p>
          ...
          <p>
            These small files store user preferences and activity data to help
            us personalize content based on your browser and behavior on our
            site.
          </p>
          ...
          <p className="mb-6">
            ...
            website. These tools help measure ad effectiveness and personalize
            ad content.
          </p>
          <p>
          ...
          <p className="mb-3 font-semibold">
            Under the CCPA (California Consumer Privacy Act), California
          ...
          <p className="mb-6">
            ...
            as encryption, firewalls, and secure servers) to protect your
          ...
          <p className="mb-6">
            If you access our services from outside India, your information may
            be transferred to, stored, and processed in countries other than
            your own. By using our services, you consent to such transfers in
          ...
          <p className="mb-6">
            If we provide paid services and you make payments through our
            website, your payment details (such as credit/debit card numbers or
            bank account information) are processed securely by third-party
            payment gateways. We do not store or directly handle sensitive
          ...
          <p className="mb-6">
            ...
            how visitors use our website. These tools may collect data such as
            IP address, device type, browser information, and on-site behavior.
            This information is used only for statistical and performance
          ...
          <p className="mb-6">
            ...
            or the handling of your personal information, please reach out to:
          </p>
          <p className="mb-2">
            📧 Email:{" "}
            <a
