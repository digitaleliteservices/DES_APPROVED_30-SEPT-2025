      ...
      <div className="min-h-screen bg-white text-gray-200 px-6 py-12 ">
        ...
        <div className="mt-10 bg-[#1a1525] rounded-2xl shadow-lg p-8 max-w-4xl mx-auto leading-relaxed">
          ...
          <p className="mb-6">
            ...
            agree to accept these terms in full. If you do not agree with any of
            the stated terms, please refrain from using our site and services.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              ...
              from our website is prohibited and may lead to legal action.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              All service deliverables, timelines, and pricing will be detailed
              in a formal proposal or contract.
            </li>
            <li>
            ...
            <li>
              All digital marketing results depend on multiple factors;
              therefore, we do not guarantee specific rankings or performance
              outcomes.
            </li>
          </ul>
          ...
          <p className="mb-6">
            ...
            disclosed during service engagement private, and not to share it
          ...
          <p className="mb-6">
            We may use third-party tools and platforms (e.g., Google Ads,
            Facebook Ads, etc.) in the delivery of our services. While we strive
            for excellence, we are not responsible for the actions or policies
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              Errors or omissions in content provided by clients or third
              parties.
            </li>
          </ul>
          ...
          <p className="mb-6">
            ...
            at any time without prior notice. Changes will be posted on this
            page, and continued use of the site signifies acceptance of the
            updated terms.
          </p>
          ...
          <p className="mb-6">
            ...
            (e.g., natural disasters, strikes, internet outages, government
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              Official notices will be sent to the contact information provided
              by you.
            </li>
          </ul>
          ...
          <p className="mb-6">
            In case of disputes, both parties agree to attempt amicable
            resolution through negotiation or mediation before pursuing legal
            remedies.
          </p>
          <p className="mb-6">
          ...
          <p className="mb-6">
            ...
            Conditions or the handling of your personal information, please
            reach out to:
          </p>
          <p className="mb-2">
            📧 Email:{" "}
